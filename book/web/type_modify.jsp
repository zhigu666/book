            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <form action="type.let?type=modify" method="post">
                                        <table width="40%" class="cont">
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td width="25%">类型编号：</td>
                                                <td width="40%"><input type="text" id="typeId" class="text"
                                                                       name="txtTypeId" value="${type.id}" disabled/>
                                            ...
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td width="25%">类型名称：</td>
                                                <td width="40%"><input type="text" id="typeName" class="text"
                                                                       name="typeName" value="${type.name}"/></td>
                                                <td class="err">*类型已存在</td>
                                                <td width="2%">&nbsp;</td>
                                            </tr>
                                            <tr>
                ...
                <tr>
                    ...
                    <td width="51%" class="left_txt">
                        <img src="./Images/icon_mail.gif" width="16" height="11"> 客户服务邮箱：1514482901@qq.com<br/>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
